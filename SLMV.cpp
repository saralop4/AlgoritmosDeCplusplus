...
int main() {
	int bonos,i,cdias,hd,hdn,hexd,hfd,hfn,shd,shdn,shexd,shexn,shfd,shn,vfd;
	float diat,eps,hexn,hjn,horas,pension,r,shfn,sn,sueldo,t,totalsaldo,trans,ts,vhd,vhdn,vhexd,vhexn,vhfd,vhfn,vhn;
	string e,em;
